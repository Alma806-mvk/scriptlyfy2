    ...
    <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-white/70 bg-white/90 border-b border-slate-200">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        <a href="/" className="flex items-center gap-2">
          <img src="https://cdn.builder.io/api/v1/image/assets%2F68b487f0ac9343bd9982add0c6af5e6d%2Fa7af90ee85c6469bae46f3d11ec5aefb?format=webp&width=800" alt="Scriptlyfy" className="h-8 w-8 object-contain bg-transparent" />
