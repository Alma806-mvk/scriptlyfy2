    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="prose prose-slate max-w-none mt-8">
        ...
        <p>
          ...
          <a href="mailto:creategenstudio@gmail.com"> creategenstudio@gmail.com</a> to exercise your rights.
        </p>
        ...
        <h2>Contact</h2>
        <p>
          Questions? Email <a href="mailto:creategenstudio@gmail.com">creategenstudio@gmail.com</a>.
        </p>
      </div>
    </div>
  );
